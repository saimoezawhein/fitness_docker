pipeline {
    ...
    parameters {
        ...
        string(
            name: 'API_HOST',
            defaultValue: 'http://72.62.66.165:3001',
...
EOF
            ...
            steps {
                script {
                    ...
                    sh """
                        ...
                        curl -f http://localhost:3001/categories || exit 1

                        # Check exercises endpoint
                        curl -f http://localhost:3001/exercises || exit 1
    ...
    post {
        success {
            echo "✅ Fitness Tracker deployment completed successfully!"
            ...
            echo "  - Users: http://localhost:3001/users"
            echo "  - Categories: http://localhost:3001/categories"
            echo "  - Exercises: http://localhost:3001/exercises"
            echo "  - Workouts: http://localhost:3001/workouts/user/:userId"
        }
